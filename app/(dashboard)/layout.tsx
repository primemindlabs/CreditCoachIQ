      ...
      <header className="sticky top-0 z-10 border-b border-line bg-paper/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-8 py-4">
          ...
          <nav className="flex items-center gap-1 text-sm text-muted">
            ...
            {canIntake && <Link href="/leads" className="rounded-control px-2.5 py-1.5 hover:bg-line/60 hover:text-ink">Leads</Link>}
            <Link href="/caseload" className="rounded-control px-2.5 py-1.5 hover:bg-line/60 hover:text-ink">Caseload</Link>
